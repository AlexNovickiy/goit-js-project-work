...
const { loaderOverlay, modalForm, stars, nameInput, messageInput, modalOverlay, closeBtn, feedbackBtn } = refs;
...
function validateForm() {
    ...
    if (messageInput.value.trim().length < 10 || messageInput.value.trim().length > 512) {
        isValid = false;
