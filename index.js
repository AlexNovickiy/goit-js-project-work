import{a as S,i as g,S as ge}from"./assets/vendor-Cq1ZEsD1.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))n(o);new MutationObserver(o=>{for(const a of o)if(a.type==="childList")for(const i of a.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&n(i)}).observe(document,{childList:!0,subtree:!0});function s(o){const a={};return o.integrity&&(a.integrity=o.integrity),o.referrerPolicy&&(a.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?a.credentials="include":o.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function n(o){if(o.ep)return;o.ep=!0;const a=s(o);fetch(o.href,a)}})();const r={burgerBtnOpenMenu:document.querySelector(".icon-burger"),burgerBtnCloseMenu:document.querySelector(".icon-close"),headerMenuContainer:document.querySelector(".header-menu-container"),loaderOverlay:document.querySelector(".loader-in"),modalForm:document.querySelector(".feedback-mod"),stars:document.querySelectorAll(".star-rating path"),nameInput:document.querySelector('.feedback-mod [name="name"]'),messageInput:document.querySelector('.feedback-mod [name="message"]'),modalOverlayArtists:document.querySelector(".modal-overlay-artists"),closeBtn:document.querySelector(".close-btn-mod"),feedbackBtn:document.querySelector(".feedback-btn"),menuAnchorAbout:document.querySelector("#menu-anchor-about"),menuAnchorArtists:document.querySelector("#menu-anchor-artists"),menuAnchorReviews:document.querySelector("#menu-anchor-reviews"),artistsGrid:document.getElementById("artists-card-id"),loadMoreBtn:document.getElementById("load-more-btn"),loader:document.querySelector(".modal-loader"),modalOverlay:document.querySelector(".modal-overlay"),body:document.querySelector("body"),closeModalBtn:document.querySelector(".close-btn"),titleName:document.querySelector(".modal-info-title"),aboutArtist:document.querySelector(".modal-info-card"),modalAlboms:document.querySelector(".modal-alboms"),artistsSection:document.querySelector("#artists-card-id")},ye=8,A="https://sound-wave.b.goit.study/api",Q="/artists",he="/genres",be="/albums",X="/feedbacks";async function Le(e=1,t="",s="",n=""){const o={limit:ye,page:e,...t&&{name:t},...s&&{sortName:s},...n&&{genre:n}};try{return(await S.get(`${A}${Q}`,{params:o})).data}catch{g.error({title:"Error",message:"Failed to fetch artists.",position:"topRight"})}}async function we(){try{return(await S.get(`${A}${he}`)).data}catch{g.error({title:"Error",message:"Failed to fetch genres.",position:"topRight"})}}async function Ee(e){try{return(await S.get(`${A}${Q}/${e}${be}`)).data}catch{g.error({title:"Error",message:"Failed to fetch albums.",position:"topRight"})}}async function ke(e=1){try{return(await S.get(`${A}${X}`,{params:{page:e}})).data}catch{g.error({title:"Error",message:"Failed to fetch feedbacks.",position:"topRight"})}}async function Se(e){try{const t=await S.post(`${A}${X}`,e);return g.success({title:"Success",message:"Feedback submitted successfully.",position:"topRight",timeout:3e3}),t.data}catch{g.error({title:"Error",message:"Failed to submit feedback.",position:"topRight"})}}const{loaderOverlay:Z,modalForm:ee,stars:te,nameInput:Y,messageInput:j,modalOverlay:L,closeBtn:Ae,feedbackBtn:$e}=r;function Me(){Z.classList.remove("hidden")}function Be(){Z.classList.add("hidden")}let f=0;te.forEach((e,t)=>{e.addEventListener("mouseenter",()=>{N(t+1)}),e.addEventListener("mouseleave",()=>{N(f)}),e.addEventListener("click",()=>{f=t+1,N(f)})});function N(e){te.forEach((t,s)=>{s<e?t.setAttribute("fill","#a76cdb"):t.setAttribute("fill","#ffffff")})}function Ne(){L.classList.add("is-open"),document.addEventListener("keydown",se)}$e.addEventListener("click",Ne);function q(){L.classList.add("is-close"),setTimeout(()=>{L.classList.remove("is-open","is-close")},300),document.removeEventListener("keydown",se)}Ae.addEventListener("click",q);L.addEventListener("click",e=>{e.target===L&&q()});function se(e){e.key==="Escape"&&q()}function Te(){let e=!0,t=[];return(Y.value.trim().length<2||Y.value.trim().length>16)&&(e=!1,t.push("Name must be between 2 and 16 characters")),(j.value.trim().length<10||j.value.trim().length>512)&&(e=!1,t.push("Message must be between 10 and 512 characters.")),(f<1||f>5)&&(e=!1,t.push("Rating must be between 1 and 5 stars.")),e||t.forEach(s=>{g.error({title:"Error",message:s,position:"topRight",timeout:3e3,pauseOnHover:!0})}),e}function qe(){ee.reset(),N(0),f=0}ee.addEventListener("submit",async e=>{if(e.preventDefault(),!Te())return;const t={name:Y.value.trim(),rating:f,descr:j.value.trim()};Me(),await Se(t),q(),qe(),Be()});const c="/goit-js-project-work-team-1/assets/sprite-wQKTNHgQ.svg";function Ie(e,t=c){const s=Math.floor(e),n=e-s,o=Math.round(n*100);let a="";for(let i=1;i<=5;i++)i<=s?a+=`
  ...
  `}function U(e,t,s){const n=document.querySelector(".swiper-button-prev"),o=document.querySelector(".swiper-button-next");n.classList.toggle("disabled",e===t),o.classList.toggle("disabled",e===s)}async function xe(){const{data:e}=await ke(),t=e.slice(0,30),s=0,n=t.length-1,o=Math.floor(t.length/2);document.querySelector(".swiper-wrapper").innerHTML=t.map(De).join("");const a=new ge(".swiper",{slidesPerView:1,loop:!1,navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"}}),i=document.querySelector(".swiper-pagination");i.innerHTML=`
    ...
    <span class="swiper-pagination-bullet" data-i="${n}"></span>`,i.addEventListener("click",l=>{l.target.classList.contains("swiper-pagination-bullet")&&a.slideTo(+l.target.dataset.i)});function y(){const l=a.realIndex;document.querySelectorAll(".swiper-pagination-bullet").forEach(h=>{h.classList.toggle("active",+h.dataset.i===l)}),U(l,s,n)}a.on("slideChange",()=>{y(),U(a.realIndex,s,n)}),y()}xe();let d=1,w="",E="",$="";const Fe=8,k=document.getElementById("searchInput"),m=document.getElementById("genreDropdown"),I=document.getElementById("genreToggle"),re=document.getElementById("genreList"),p=document.getElementById("sortingDropdown"),O=document.getElementById("sortingToggle"),Pe=document.getElementById("sortingList"),Re=document.getElementById("resetBtn"),_e=document.getElementById("resetFiltersBtn"),V=document.querySelector(".icon-chevron"),Ge=document.getElementById("artists-card-id"),G=document.querySelector(".spinner"),W=r.artistsGrid,T=r.loadMoreBtn,J=document.getElementById("emptyState"),Ye=document.querySelector(".search-and-filters-opener"),z=document.querySelector(".filters-panel"),b=document.querySelector(".scrollBtnUp");function M(){m.classList.remove("open"),p.classList.remove("open")}I.addEventListener("click",()=>{m.classList.contains("open")?(m.classList.remove("open"),m.querySelector(".icon-chevron").innerHTML=`<use href="${c}#icon-chevron-up-arrow"></use>`):(M(),m.classList.add("open"),m.querySelector(".icon-chevron").innerHTML=`<use href="${c}#icon-chevron-down-arrow"></use>`)});O.addEventListener("click",()=>{p.classList.contains("open")?(p.classList.remove("open"),p.querySelector(".icon-chevron").innerHTML=`<use href="${c}#icon-chevron-up-arrow"></use>`):(M(),p.classList.add("open"),p.querySelector(".icon-chevron").innerHTML=`<use href="${c}#icon-chevron-down-arrow"></use>`)});document.addEventListener("click",e=>{!m.contains(e.target)&&!p.contains(e.target)&&M()});Ye.addEventListener("click",()=>{z.classList.toggle("open"),z.classList.contains("open")?V.innerHTML=`<use href="${c}#icon-chevron-down-arrow"></use>`:V.innerHTML=`<use href="${c}#icon-chevron-up-arrow"></use>`});async function je(){const e=await we();e!=null&&e.length&&(re.innerHTML='<div class="dropdown-item" data-value="">Default</div>'+e.map(t=>`<div class="dropdown-item" data-value="${t.genre}">${t.genre}</div>`).join(""))}je();Pe.addEventListener("click",e=>{e.target.classList.contains("dropdown-item")&&(E=e.target.dataset.value==="default"?"":e.target.dataset.value,O.querySelector(".dropdown-title").textContent=`${E||"Default"}`,d=1,M(),u(!0))});re.addEventListener("click",e=>{e.target.classList.contains("dropdown-item")&&(w=e.target.dataset.value==="Default"?"":e.target.dataset.value,I.querySelector(".dropdown-title").textContent=`${w||"Default"}`,d=1,M(),u(!0))});k.addEventListener("keydown",e=>{e.key==="Enter"&&($=k.value.trim(),d=1,u(!0))});z.addEventListener("submit",e=>{e.preventDefault(),$=k.value.trim(),d=1,u(!0)});Re.addEventListener("click",()=>{w="",E="",$="",k.value="",I.querySelector(".dropdown-title").textContent="Genres",O.querySelector(".dropdown-title").textContent="Sorting",d=1,u(!0)});_e.addEventListener("click",()=>{w="",E="",$="",k.value="",I.querySelector(".dropdown-title").textContent="Genres",O.querySelector(".dropdown-title").textContent="Sorting",d=1,u(!0)});T.addEventListener("click",async()=>{d++,await u(),window.scrollBy({top:document.querySelector(".artist-card").clientHeight*2,behavior:"smooth"})});async function u(e=!1){T.style.display="none",J.classList.add("hidden"),G.classList.remove("hidden"),e&&(W.innerHTML="");const t={page:d,name:$,sortName:E||void 0,genre:w||void 0},s=await Le(t.page,t.name,t.sortName,t.genre),n=(s==null?void 0:s.artists)||[];if(e&&n.length===0){J.classList.remove("hidden"),Ge.innerHTML="",G.classList.add("hidden");return}Oe(n,W),s.page*Fe>=s.totalArtists?T.style.display="none":T.style.display="flex",G.classList.add("hidden")}u(!0);function ze(){window.scrollY>(document.body.scrollHeight-window.innerHeight)/2?b.classList.add("visible-scrollBtn"):b.classList.remove("visible-scrollBtn");function e(){window.scrollTo({top:0,behavior:"smooth"})}b.classList.contains("visible-scrollBtn")?b.addEventListener("click",e):b.removeEventListener("click",e)}document.addEventListener("scroll",ze);window.history.scrollRestoration="manual";window.addEventListener("load",()=>{window.scrollTo(0,0)});function oe(e){e.target===r.modalOverlayArtists&&C()}function ae(e){r.modalOverlayArtists.classList.contains("is-open")&&e.key==="Escape"&&C()}function Ke(e,t){const s=parseInt(e,10),n=parseInt(t,10);return isNaN(s)&&isNaN(n)?"information missing":!isNaN(s)&&isNaN(n)?`${s}–present`:!isNaN(s)&&!isNaN(n)?`${s}–${n}`:"information missing"}function Ue(e){if(typeof e=="string"){const a=parseInt(e,10);if(isNaN(a))return"N/A";e=a}if(e==null||isNaN(e))return"N/A";const t=Math.floor(e/1e3),s=Math.floor(t/60),n=t%60,o=n<10?`0${n}`:n;return`${s}:${o}`}async function Ve(e,t=[]){He();const s=r.aboutArtist.querySelector(".modal-info-description");s&&(s.innerHTML=""),r.modalAlboms.innerHTML="";const n=await Ee(e),{strArtist:o,strArtistThumb:a,strGender:i,intMembers:y,strCountry:l,strBiographyEN:h,intFormedYear:ie,intDisbandedYear:ce,albumsList:H}=n;r.titleName.textContent=o||"N/A";const le=Ke(ie,ce);let D="";t&&Array.isArray(t)&&t.length>0&&(D=t.map(B=>`<span class="genre-tag">${B.trim()}</span>`).join(""));const de=` <img class="ph-artist" src="${a}" alt="${o}" />
  <div class="modal-info-description">
            ...
            </div>`;r.aboutArtist.innerHTML=de;let x="";H&&H.length>0?H.forEach(B=>{const me=B.strAlbum||"Unknown Album",F=B.tracks;let P="";F&&F.length>0?F.forEach((R,pe)=>{const fe=(pe+1)%2===0?"albom-track even":"albom-track odd",_=R.movie,ve=typeof _=="string"&&_.trim()!==""?`<a class="link-icon-youtube" href="${_}" target="_blank" rel="noopener noreferrer" aria-label="Watch on YouTube">
